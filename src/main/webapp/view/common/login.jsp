					...
					<div class="login-content">
						...
						<div class="login-form" style="margin-top: -50px;">
							<form action="login" method="post">
								...
								<div>
									<a style="padding: 15px 25px; margin-left: 25%"
										class="hollow button primary"
										href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/house-booking-swp391/login&response_type=code
    									&client_id=88179618778-1pobvpfpbc5da9q5uic4scv623gjefag.apps.googleusercontent.com&approval_prompt=force">
										<img width="15px"
							...
							<div class="register-link">
								<p>
									Don't you have account? <a
										href="${pageContext.request.contextPath}/sign-up">Sign Up
										Here</a>
								</p>
							</div>
						</div>
