...
<div class="header_agileits">
    ...
    <c:if test = "${fn:contains(theString, 'home.jsp')}">
        <div class="logo">	
            <h1>
                <a class="navbar-brand" href="${pageContext.request.contextPath}/home"><span>House</span></a>
                <a class="navbar-brand" href="${pageContext.request.contextPath}/booking"> <i> Booking</i></a>
            </h1>
        </div>
