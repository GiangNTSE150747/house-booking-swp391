                                        ...
                                        <form action="" method="post" novalidate="novalidate">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-4">
                                                    ...
                                                    <select name="selectTinh" id="selectTinh" class="form-control">
                                                ...
                                                <div class="col-4">
                                                    <label for="selectTP" class=" form-control-label">Thành phố</label>
                                                    <select name="selectTP" id="selectTP" class="form-control">
                                                        <option value="0">Please select</option>
                                                        <option value="1">Option #1</option>
                                                        <option value="2">Option #2</option>
                                                        <option value="3">Option #3</option>
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <select name="selectHuyen" id="selectHuyen" class="form-control">
                                                        <option value="0">Please select</option>
                                                        <option value="1">Option #1</option>
                                                        <option value="2">Option #2</option>
                                                        <option value="3">Option #3</option>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-5">
                                                    <label for="file-multiple-input" class=" form-control-label">Thêm hình ảnh 1</label>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-5">
                                                    <label for="file-multiple-input" class=" form-control-label">Thêm hình ảnh 2</label>
                                                </div>
                                                <div class="col-12 col-md-7">
                                                    <input type="file" id="file-input" name="file-input" class="form-control-file">
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-5">
                                                    <label for="file-multiple-input" class=" form-control-label">Thêm hình ảnh 3</label>
                                                </div>
                                                <div class="col-12 col-md-7">
                                                    <input type="file" id="file-input" name="file-input" class="form-control-file">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label for="textarea-input" class="control-label mb-1">Mô tả</label>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">Tình trạng</label>
                                            <input type="text" id="company" placeholder="" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Thời hạng cho thuê</label>
                                            <input type="text" id="vat" placeholder="" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="street" class=" form-control-label">Sức chứa</label>
                                            ...
                                            <div class="row form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="checkbox1" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox1" name="checkbox1" value="option1" class="form-check-input">Bãi đỗ xe
                                                            </label>
                                                        </div>
                                                        <div class="checkbox">
                                                            <label for="checkbox2" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox2" name="checkbox2" value="option2" class="form-check-input">Vật nuôi
                                                            </label>
                                                        </div>
                                                        <div class="checkbox">
                                                            <label for="checkbox3" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox3" name="checkbox3" value="option3" class="form-check-input">Wifi miễn phí
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col col-md-4">
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="checkbox1" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox1" name="checkbox1" value="option1" class="form-check-input">Hồ bơi
                                                            </label>
                                                        </div>
                                                        <div class="checkbox">
                                                            <label for="checkbox2" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox2" name="checkbox2" value="option2" class="form-check-input">Bàn làm việc
                                                            </label>
                                                        </div>
                                                        <div class="checkbox">
                                                            <label for="checkbox3" class="form-check-label ">
